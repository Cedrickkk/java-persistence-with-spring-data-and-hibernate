...
import org.spring.data.springdatajpa.springdatajpa2.repositories.UserRepository;
...
abstract class SpringDataJpa2ApplicationTests {
    @Autowired
    ...
    private static List<User> generateUsers() {
        ...
        User hulaanmo = new User("hula@nm0", LocalDate.of(2025, Month.OCTOBER, 12));
        hulaanmo.setEmail("hula@nm0@gmail.com");
        hulaanmo.setLevel(1);
        hulaanmo.setActive(true);
