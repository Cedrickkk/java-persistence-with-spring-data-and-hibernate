...
public class FindUsersSortingAndPagingTest extends SpringDataJpa2ApplicationTests {
    @Test
    void testOrder() {
        ...
        List<User> userList = userRepository.findFirst2ByLevelOrderByRegistrationDate(2);

        assertAll(
                () -> assertEquals(2, userList.size()),
                () -> assertEquals("beth", user1.getUsername()),
                () -> assertEquals("hula@nm0", user2.getUsername()),
