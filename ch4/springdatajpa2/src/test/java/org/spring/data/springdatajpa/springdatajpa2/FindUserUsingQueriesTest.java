...
public class FindUserUsingQueriesTest extends SpringDataJpa2ApplicationTests {
    @Test
    void testFindAll() {
    ...
    @Test
    void testFindUser() {
        User hulaanmo = userRepository.findByUsername("hula@nm0");
        assertEquals("hula@nm0", hulaanmo.getUsername());
    }
